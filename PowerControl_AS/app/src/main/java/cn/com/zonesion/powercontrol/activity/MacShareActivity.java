...
public class MacShareActivity extends Activity{
	 /**
     * 用来显示二维码图片
     */
    ...
    private void initView() {
        ...
        String sensora = intent.getStringExtra("sensora");
        String sensorb = intent.getStringExtra("sensorb");
        String sensorc = intent.getStringExtra("sensorc");

        //将获取到的数据通过构造方法赋值给IdKeyBean
        MacBean idKeyBean = new MacBean(sensora,sensorb,sensorc);
